...
export const routes = [
  ...
  { path: PATHS.financeRecommendationResult, name: 'recommendation-result', component: () => import('@/views/RecommendationResultView.vue'), meta: { requiresAuth: true, process: true } },
