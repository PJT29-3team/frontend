...
export const routes = [
  ...
  { path: PATHS.financeRecommendation, name: 'recommendation', component: () => import('@/views/RecommendationConditionView.vue'), meta: { requiresAuth: false, process: true } },
  { path: PATHS.financeRecommendationResult, name: 'recommendation-result', component: () => import('@/views/RecommendationResultView.vue'), meta: { requiresAuth: false, process: false } },
