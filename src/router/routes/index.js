...
export const routes = [
  ...
  { path: PATHS.financeRecommendation, name: 'recommendation', component: () => import('@/views/RecommendationConditionView.vue'), meta: { requiresAuth: true } },
  { path: PATHS.financeRecommendationResult, name: 'recommendation-result', component: () => import('@/views/RecommendationResultView.vue'), meta: { requiresAuth: true } },
  { path: PATHS.financeRecommendationFavorites, name: 'recommendation-favorites', component: () => import('@/views/RecommendationFavoritesView.vue'), meta: { requiresAuth: true } },
