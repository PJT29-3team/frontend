...
export const routes = [
  ...
  { path: PATHS.surveyProcess, component: () => import('@/views/property/ProcessPlaceholderView.vue'), meta: { requiresAuth: true, process: true, title: '설문 조사', description: '나에게 꼭 맞는 주거 조건을 확인하는 설문 조사 페이지입니다.' } },
  { path: PATHS.recommendedProperty, component: () => import('@/views/property/ProcessPlaceholderView.vue'), meta: { requiresAuth: true, process: true, title: '추천 매물', description: '설문 결과를 바탕으로 추천 매물을 살펴보는 페이지입니다.' } },
  ...
  { path: PATHS.survey, name: 'survey', component: () => import('@/views/property/ProcessPlaceholderView.vue'), meta: { requiresAuth: true, process: true, title: '설문 조사', description: '나에게 꼭 맞는 주거 조건을 확인하는 설문 조사 페이지입니다.' } },
  { path: `${PATHS.survey}/:surveyId`, name: 'survey-resume', component: () => import('@/views/property/ProcessPlaceholderView.vue'), props: true, meta: { requiresAuth: true, process: true, title: '설문 조사', description: '나에게 꼭 맞는 주거 조건을 확인하는 설문 조사 페이지입니다.' } },
]
